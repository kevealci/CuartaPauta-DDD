...
public class ActualizarDeberDepartamento extends Command {

    private final VendedorId vendedorId;
    private final DepartamentoId departamentoId;
    private final Deber deber;

    public ActualizarDeberDepartamento(VendedorId vendedorId, DepartamentoId departamentoId, Deber deber){
